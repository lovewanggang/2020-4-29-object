		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="javascript:void(0)">小程序管理后台</a> <a aria-hidden="false"
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<!-- <li class="dropDown dropDown_hover"><a href="#"
							...
							<li><a onclick="window.location.href='<%=basePath%>pages/company/login.jsp'">退出</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<!-- <dl id="menu-article">
				...
				<dd>
					<ul>
						<li><a data-href="账号管理列表.html" data-title="账户管理列表"
							href="javascript:void(0)">账户管理列表</a></li>
						<li><a data-href="添加公司信息.html" data-title="添加公司信息"
							href="javascript:void(0)">添加公司信息</a></li>
						<li><a data-href="统计.html" data-title="统计功能"
							href="javascript:void(0)">统计功能</a></li>
					</ul>
				</dd>
			</dl> -->
			<dl id="menu-picture">
			...
			<dl id="menu-product">
				...
				<dd>
					<ul>
						...
						<li><a data-href="<%=basePath %>pages/company/userAnalysis.jsp" data-title="用户分析"
							href="javascript:void(0)">用户分析</a></li>
					</ul>
					</ul>
				</dd>
			</dl>
