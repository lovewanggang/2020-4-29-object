...
$.ajax({
			url:"<%=basePath%>company/findOneProductClass.do",
			type:"post",
			dataType:"json",
			data:{
				"id":id
			...
			success:function(data){
				$("#productClassId").val(data.productClass.productClassId);
				$("#pclassPic").attr("src",data.productClass.pcClassPic);
				$("#name").val(data.productClass.pcName);
			},
			error:function (){
				alert("获取数据失败");
			}
...
function getQueryString(id) { 
	...
	function edit(){
		var id=getQueryString("id");
		$.ajax({
			url:"<%=basePath%>company/editProductClass.do",
			type:"post",
			dataType:"json",
			data:{
				"productClass.pcName":$("#name").val(),
				"productClass.pcClassPic":$("#pclassPic").attr("src"),
				"productClass.productClassId":$("#productClassId").val()
			},
			success:function(data){
				alert("修改成功");
			},
