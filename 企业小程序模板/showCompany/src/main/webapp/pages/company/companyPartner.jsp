...
function uploadPartnerPic(){
	$.ajaxFileUpload({
		type : "post",
		url : "<%=basePath%>company/uploadPartnerImage.do",
		dataType : 'json',
...
function updatePartnerImg(){
	...
	$.ajax({
		url:"<%=basePath%>company/updatePartnerImage.do",
		type:"post",
		dataType:"json",
		data:{
			"str":tmp
...
function onoff(){
	$.ajax({
		url:"<%=basePath%>company/partnerOnoff.do",
		type:"post",
		dataType:"json",
		success:function (data){
...
<body>
	...
	<article class="page-container">
		<p class="blue">让大家知道我们公司是有实力的存在!</p>
		<form class="form form-horizontal" id="form-article-add">
			<div class="row cl">
				<label class="form-label col-xs-12 col-sm-12 "><span
					class="c-red">*</span>上传合作伙伴LOGO： <span class="stip">建议上传尺寸规格为290*400的图片，否则将被截取，仅只支持jpg、jpeg、png格式</span></label>
				<div class="formControls col-xs-12 col-sm-12 ">
					<ul class=" hb_t">
						<!--已经添加了图片的-->
						<s:iterator value="partners">
						<li class="appendImg"><img name="img" src="${partnerLogo }"
							class="tp">
							<p class="showp">
						...
						<li id="addImg">
							...
							<input id="uploadPic" name="image" onchange="uploadPartnerPic()" type="file" class="file">
						</li>
					</ul>
			...
			<div class="row cl" style="margin-top: 50px;">
				<div class="col-xs-8 col-sm-9 ">
					<!-- <button class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
					 --><button class="btn btn-primary radius ml-30" type="button" onclick="updatePartnerImg()">
